...
<header id="header" class="header d-flex align-items-center sticky-top">
    <div class="container position-relative d-flex align-items-center justify-content-between">
      ...
      <nav id="navmenu" class="navmenu">
        <ul>
        <li><a href="{{ route('user.profile') }}" ><i class="bi bi-person-circle"></i><br></a></li>
          <li><a href="{{ route('user.chat') }}" ><i class="bi bi-chat-square-text"></i><br></a></li>
          <li><a href="{{ route('user.home') }}">Home<br></a></li>
          <li><a href="{{ route('user.weddingorganizer') }}">Wedding Organizer</a></li>
          <li><a href="{{ route('user.partyorganizer') }}">Party Organizer</a></li>
          <li><a href="{{ route('user.riwayat') }}">Pemesanan</a></li>
