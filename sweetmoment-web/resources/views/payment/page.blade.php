    ...
    <div class="payment-container mt-5">
        ...
        <div class="payment-card">
            <div class="payment-header">
                ...
                <p class="mb-0">Secure payment powered by Pakasir</p>
            </div>
            ...
            <div class="payment-methods text-center">
                <button type="button" class="pay-button py-3 mb-4" id="payButton">
                ...
                <div class="security-info text-start">
                    <div class="d-flex align-items-center">
                        ...
                        <small>
                            ...
                            We support all major payment methods including QRIS and Virtual Accounts (bank transfer) via Pakasir.
                        </small>
                    </div>
                </div>
            </div>
