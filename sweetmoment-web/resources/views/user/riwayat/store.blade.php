...
<path d="M3 13.4597C3 17.6241 6.4742 21 10.7598 21C14.0591 21 16.8774 18.9993 18 16.1783C17.1109 16.5841 16.1181 16.8109 15.0709 16.8109C11.2614 16.8109 8.17323 13.8101 8.17323 10.1084C8.17323 8.56025 8.71338 7.13471 9.62054 6C5.87502 6.5355 3 9.67132 3 13.4597Z" stroke="#1B1B1B" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
  ...
  <label for="nama_pemesan">Nama Pemesan</label>
    <input type="text" id="nama_pemesan" name="nama_pemesan" placeholder="{{ $pembayaran->nama_pemesan }}" readonly/>
  <br>
  <label for="nama_vendor">Nama Pemesan</label>
    <input type="text" id="nama_vendor" name="nama_vendor" placeholder="{{ $pembayaran->nama_vendor }}" readonly/>
  <br>
  <label for="tanggal_acara">Tanggal Acara</label>
    <input type="text" id="tanggal_acara" name="tanggal_acara" placeholder="{{ $pembayaran->tanggal_acara }}" readonly/>
  <br>
  <label for="harga">Total Harga</label>
    <input type="text" id="harga" name="harga" placeholder="{{ $pembayaran->harga }}" readonly/>
  <br>
  <div class="exp-cvc">
...
<div class="btn">
    ...
    <span><a href="{{ route('user.riwayat.add') }}">Kembali</a></span>
</div>
</div>
</div>
